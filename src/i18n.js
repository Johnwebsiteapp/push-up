...
const pl = {
  ...
  gym_add_hint: 'Ćwiczenie pojawi się na każdy dzień — wystarczy wpisać serie.',
...
const en = {
  ...
  gym_confirm_no: 'No',
  gym_move_up: 'Move up',
  gym_move_down: 'Move down',
  gym_history_prev: 'Previously',
  gym_history_none: 'No previous workout',
  gym_add_hint: 'The exercise shows up every day — just log your sets.',
